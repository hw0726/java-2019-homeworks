...
class HuluwaManager{
    private final String HULUWA_CONF_FILE = "./conf/huluwa.conf";
    private final String NAME_ORDER_CONF_FILE= "./conf/name_order.conf";
    private final String COLOR_ORDER_CONF_FILE= "./conf/color_order.conf";
    ...
    public HuluwaManager(){
        ...
        try {
            ...
            //生成初始位置
            //TODO
            int[] location = new int[]{2, 0, 4, 6, 1, 3, 5};
